...
class StockAnalysisTasks():
  def research(self, agent, company):
    return Task(description=dedent(f"""
        ...
        1. Search news on the internet: Use this to find recent news about {company}.
        2. Scrape website content: Use this with specific URLs, such as "{company}'s official investor relations page" or news article URLs you find.
        3. Search internet: Use this for general information about {company} and its stock.
